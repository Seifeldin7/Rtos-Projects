...
#define PEDSTARIAN_SW				(*(GPIO_PORTF_DATA_BITS_R + (1U << 0)))
#define RTL_TRAIN_SW				(*(GPIO_PORTF_DATA_BITS_R + (1U << 4)))
#define LTR_TRAIN_SW				(*(GPIO_PORTE_DATA_BITS_R + (1U << 4)))

#define TRAFFIC_LIGHT				(*(GPIO_PORTE_DATA_BITS_R + 0xF))
...
#define BOARD_LED						(*(GPIO_PORTF_DATA_BITS_R + 0xE))
